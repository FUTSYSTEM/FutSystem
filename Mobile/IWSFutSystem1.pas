...
// WSDL     : http://localhost:8081/wsdl/IWSFutSystem
//  >Import : http://localhost:8081/wsdl/IWSFutSystem>0
// Version  : 1.0
// (03/06/2016 00:29:13 - - $Rev: 76228 $)
// ************************************************************************ //
...
type
  ...
  published
    ...
    property Compareceu:   Boolean  read FCompareceu write FCompareceu;
  end;
  ...
  // URL       : http://localhost:8081/soap/IWSFutSystem
  // ************************************************************************ //
  IWSFutSystem = interface(IInvokable)
  ['{8C81B5B6-1369-96F7-357F-A4E3AB63B70C}']
    function  GetAtletas(const Codigo: Integer; const Cid_IBGE: Integer): TListAtletas; stdcall;
    function  GetCampos(const Codigo: Integer; const Cid_IBGE: Integer): TListCampos; stdcall;
    ...
    function  DeletePartidaAtleta(const Par_Codigo: Integer; const Atl_Codigo: Integer; const Tim_Codigo: Integer): Boolean; stdcall;
    function  DeleteTimeAtleta(const Atl_Codigo: Integer; const Tim_Codigo: Integer): Boolean; stdcall;
  end;
...
const
  defWSDL = 'http://localhost:8081/wsdl/IWSFutSystem';
  defURL  = 'http://localhost:8081/soap/IWSFutSystem';
